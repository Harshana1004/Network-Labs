...
{
    // TODO
    mat->data = realloc(mat->data,(mat->num_rows+1)*sizeof(int*));
    mat->data[mat->num_rows] = malloc(mat->num_cols*sizeof(int));
...
void add_col(matrix *mat, int *col)
{
    ...
    for (int i=0;i<mat->num_rows;i++){
        mat->data[i] = realloc(mat->data[i],(mat->num_cols+1)*sizeof(int));
